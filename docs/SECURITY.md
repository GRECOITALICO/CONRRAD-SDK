...
Vulnerabilities in the CONRRAD SDK may affect wallets, escrow contracts,
and M2M payment flows. Responsible disclosure protects users while we work on a fix.

### How to Report

Send an encrypted email to **security@conrrad.site** with:
...
You may encrypt your report with our PGP key (available at `https://conrrad.site/.well-known/security.txt`).
