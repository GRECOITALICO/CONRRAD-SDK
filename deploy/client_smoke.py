...
def main() -> int:
    ...
    try:
        import conrrad_sdk as sdk  # pylint: disable=import-outside-toplevel
    ...
    try:
        from conrrad_sdk.router import (  # pylint: disable=import-outside-toplevel
            IntelligentRouter,
            PolicyLiteClient,
            TelemetryCollector,
            TelemetryConfig,
    ...
    if _bool_env("SDK_SMOKE_FAILURE_MODE", "1"):
        try:
            from conrrad_sdk.router import IntelligentRouter  # pylint: disable=import-outside-toplevel
