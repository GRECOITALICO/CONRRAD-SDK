"""
CONRRAD SDK — Agent Runtime (Phase 5)
═════════════════════════════════════════
...
Usage:
    from conrrad_sdk.agent_runtime import (
...
from conrrad_sdk.agent_persistence import (
    CheckpointManager, AgentStateSnapshot, TaskStatus
)
from conrrad_sdk.agent_validation import ToolValidator
from conrrad_sdk.agent_world_model import WorldModelState, WorldModelUpdater
from conrrad_sdk.agent_reliability import ReliabilityEngine, FailurePolicy
from conrrad_sdk.interaction_router import InteractionRouter
from conrrad_sdk.observability.event_bus import GLOBAL_EVENT_BUS

# Phase 9: Sully Compute Allocation + Swarm Orchestration
from conrrad_sdk.sully.types import TaskFeatures, Tier
from conrrad_sdk.sully.engine import SullyEngine
from conrrad_sdk.sully.market import ModelMarketRegistry, GroqMarketProvider, OpenRouterMarketProvider, LocalMarketProvider
from conrrad_sdk.swarm.orchestrator import SwarmOrchestrator
from conrrad_sdk.swarm.decomposer import TaskDecomposer
from conrrad_sdk.swarm.consensus import ConsensusEngine

logger = logging.getLogger("conrrad.agent")
...
class MemoryStore:
    ...
    Note: in-memory dict. Pluggable to Redis/SQLite/vector DB.
    """
