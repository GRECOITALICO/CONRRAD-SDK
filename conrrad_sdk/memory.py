"""
CONRRAD SDK — Cortex Shared Memory
══════════════════════════════════════
...
logger = structlog.get_logger("conrrad.memory")
...
MEMORY_KEY_PREFIX = "conrrad:memory"
STREAM_KEY_PREFIX = "conrrad:stream"
...
class Memory:
    ...
    def __init__(self, agent_id: str, config: Optional[ConrradConfig] = None):
