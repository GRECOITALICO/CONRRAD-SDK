"""
CONRRAD SDK — Agent Roles (Cognitive Identity)
══════════════════════════════════════════════════
...
logger = logging.getLogger("conrrad.cognitive.agent")
...
class CognitiveAgent:
    """
    A cognitive agent in the CONRRAD swarm.
    ...
    model_id: str = ""             # Reference to a model in conrrad.yaml
