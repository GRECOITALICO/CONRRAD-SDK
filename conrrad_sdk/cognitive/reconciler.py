...
logger = logging.getLogger("conrrad.reconciler")
...
if __name__ == "__main__":
    ...
    pg_dsn = os.environ.get("CONRRAD_PG_DSN", "dbname=conrrad user=conrrad password=securepassword host=localhost")
    redis_url = os.environ.get("CONRRAD_REDIS_URL", "redis://localhost:6379")
