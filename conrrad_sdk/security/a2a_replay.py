...
⚠️  MULTI-NODE WARNING: This implementation is single-process (in-memory).
    ...
    from `conrrad_sdk.security.a2a_replay_redis` to share the nonce store
...
class A2AReplayGuard:
    ...
    def __init__(
        ...
        *,
        ...
        if os.environ.get("CONRRAD_ENV", "development") == "production":
            raise RuntimeError(
                ...
                "Use A2AReplayGuardRedis (conrrad_sdk.security.a2a_replay_redis) "
                "and set CONRRAD_REDIS_URL to a shared Redis instance."
            )
