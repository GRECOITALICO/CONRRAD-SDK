# conrrad_sdk/crypto/passport.py — PATCH: AES-128-CBC → AES-256-GCM
#
...
# ──────────────────────────────────────────────────────────────────────────────
_CIPHER_LABEL   = b"conrrad-passport-v2"   # AAD — autenticación del contexto
    ...
    def unseal(
        ...
        if blob.get("version", 1) < 2:
            raise MigrationRequired(
                ...
                "Ejecuta `conrrad migrate-passport` para actualizarlo a AES-256-GCM."
            )
