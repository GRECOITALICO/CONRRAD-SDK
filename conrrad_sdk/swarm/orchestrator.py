"""
CONRRAD SDK — Swarm Orchestrator
═══════════════════════════════════
...
from conrrad_sdk.sully.types import TaskFeatures, FinalOutcome, Tier
from conrrad_sdk.sully.engine import SullyEngine
from conrrad_sdk.sully.market import ModelMarketRegistry
from conrrad_sdk.swarm.decomposer import TaskDecomposer, TaskDAG, SubTask
from conrrad_sdk.swarm.executor import SwarmExecutor
from conrrad_sdk.swarm.consensus import ConsensusEngine, Candidate
from conrrad_sdk.swarm.budget import SwarmBudgetManager
from conrrad_sdk.observability.event_bus import GLOBAL_EVENT_BUS

logger = logging.getLogger("conrrad.swarm.orchestrator")
