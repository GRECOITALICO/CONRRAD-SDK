"""
log_redactor.py — CONRRAD SDK
Fix #7: Procesador de structlog que redacta automáticamente secretos en logs.

Integración:
    import structlog
    from conrrad_sdk.log_redactor import build_redacting_processor, configure_logging
...
_ENV = os.environ.get("CONRRAD_ENV", "production").lower()
...
def _redact_string(key: str, value: str) -> str:
    ...
    if (
        ...
        return (
            ...
            + "set CONRRAD_ENV=dev para ver completo]"
        )
...
def get_logger(name: str) -> structlog.stdlib.BoundLogger:
    ...
    Uso:
        from conrrad_sdk.log_redactor import get_logger
