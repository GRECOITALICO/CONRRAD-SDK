...
Key difference from Cursor:
  ...
  - Conrrad sends structured context to N specialized agents via the marketplace.
...
logger = logging.getLogger("conrrad.devlayer.context")
...
class ContextRouter:
    ...
    def __init__(self, project_root: str, ignore_patterns: Optional[Set[str]] = None):
        ...
        self._index_cache_path = self.project_root / ".conrrad" / "index.json"
