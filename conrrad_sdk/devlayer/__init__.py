...
CONRRAD — DevLayer
═════════════════════
The developer-facing interface to the Conrrad distributed execution fabric.
...
Components:
  ...
  - TaskClient:     Submits tasks to the Conrrad network and tracks execution
  - PreviewEngine:  Renders diffs, receipts, and agent reputation for review
  - CLI (conrrad dev): Developer-facing commands
"""
__version__ = "0.1.0"
