"""
Conrrad WAL Replicator — Active-Passive Shadow Replication & Leader Enforcement
...
class WALReplicator:
    ...
    STREAM_KEY = "conrrad:wal:replication"
...
class ReplicationConsumer:
    ...
    def __init__(self, redis_local, region: str):
        self.r = redis_local
        self.region = region
        self.seen_key = f"conrrad:replication:seen:{region}"
        self.last_id = "0-0"
