"""
Conrrad Pay Fuzzer — Financial Invariant Stress Testing
...
class ConrradPayFuzzer:
    ...
    def run_all(self):
        print("=" * 70)
        print("  CONRRAD PAY FUZZER — Financial Invariant Testing")
        print("=" * 70)
    ...
    def test_reversal_after_capture(self):
        ...
        entries_before = len(r.streams.get("conrrad:ledger", []))
        settlement.compensate("user_9", 5000, "req-9")
        entries_after = len(r.streams.get("conrrad:ledger", []))
