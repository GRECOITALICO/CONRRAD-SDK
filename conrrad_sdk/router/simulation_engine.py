...
logger = logging.getLogger("conrrad.runtime.simulation")
...
class WALEventAdapter:
    def __init__(self, redis_client, stream="conrrad:wal"):
        self.r = redis_client
        self.stream = stream
    ...
    def _normalize(self, eid: str, data: Dict[str, Any]) -> NormalizedEvent:
        ...
        if req_id.startswith("conrrad:exec:"):
            req_id = req_id.split("conrrad:exec:")[1]
...
from conrrad_sdk.router.execution_resilience import alert_manager
