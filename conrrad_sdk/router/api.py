...
from conrrad_sdk.router.simulation_engine import SimulationEngine, WALEventAdapter
from conrrad_sdk.router.reconciler import reconcile_from_timelines
from conrrad_sdk.router.reconciliation_executor import ReconciliationExecutor

app = FastAPI(title="Conrrad Incident Time Travel UI API")
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# Conrrad Pay — Financial Ledger API
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

from conrrad_sdk.router.conrrad_pay import (
...
from conrrad_sdk.router.marketplace import (
...
from conrrad_sdk.router.hardening import (
...
REGION = os.getenv("CONRRAD_REGION", "A")
...
def force_failover(request_id: str, ttl: float = 300.0):
    ...
    if redis_client:
        ...
        redis_client.xadd("conrrad:wal", event)
