"""
CONRRAD SDK — Router Entrypoint (Dual Router + Feature Flags)
═════════════════════════════════════════════════════════════════
...
logger = logging.getLogger("conrrad.router.entrypoint")
...
class RouterConfig:
    ...
    classifier_model_tag: str = "conrrad-classifier:latest"  # Ollama tag


class HistoricalRouter(Protocol):
...
class RouterEntrypoint:
    ...
    def __init__(
        self,
        legacy_router: Optional[HistoricalRouter] = None,
