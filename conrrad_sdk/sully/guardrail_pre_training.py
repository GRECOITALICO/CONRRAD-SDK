"""
CONRRAD SDK — Pre-Training Data Guardrail
════════════════════════════════════════════
...
from conrrad_sdk.internal.paths import default_sully_dataset_file
...
logger = logging.getLogger("conrrad.sully.guardrail")


class DataGuardrail:
    """Blocks training if the dataset violates learning invariants."""
    
    def __init__(self, dataset_path: str = str(default_sully_dataset_file())):
