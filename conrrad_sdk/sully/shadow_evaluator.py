"""
CONRRAD SDK — Shadow Deployment Evaluator
════════════════════════════════════════════
...
from conrrad_sdk.internal.paths import default_sully_shadow_log

logger = logging.getLogger("conrrad.sully.shadow_eval")

class ShadowEvaluator:
    def __init__(self, shadow_log_path: str = str(default_sully_shadow_log())):
