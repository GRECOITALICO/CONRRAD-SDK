"""
CONRRAD SDK — Model Market Registry (Pricing Oracle)
═══════════════════════════════════════════════════════
...
from conrrad_sdk.sully.types import ModelMarketInfo, Tier

logger = logging.getLogger("conrrad.sully.market")
...
class OpenRouterLiveMarketProvider(ModelMarketProvider):
    ...
    def _fetch_live(self) -> List[ModelMarketInfo]:
        ...
        headers = {"User-Agent": "Conrrad-SDK/3.1"}
        if self._api_key:
