"""
CONRRAD SDK — Local LoRA Finetuning Pipeline
═══════════════════════════════════════════════
...
from conrrad_sdk.internal.paths import default_sully_dataset_file, default_sully_models_dir
from conrrad_sdk.sully.guardrail_pre_training import DataGuardrail, resample_for_training

logger = logging.getLogger("conrrad.sully.trainer")
...
def train(
    ...
    dataset_path: str = str(default_sully_dataset_file()),
    output_dir: str = str(default_sully_models_dir()),
):
