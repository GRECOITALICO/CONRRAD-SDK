"""
CONRRAD SDK — Sully Training Pipeline
════════════════════════════════════════
...
from conrrad_sdk.internal.paths import default_sully_root
from conrrad_sdk.observability.event_bus import GLOBAL_EVENT_BUS

logger = logging.getLogger("conrrad.sully.training")
...
class TrainingPipeline:
    ...
    def __init__(self, output_dir: str = str(default_sully_root())):
