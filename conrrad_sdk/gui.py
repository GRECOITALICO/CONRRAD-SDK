"""
CONRRAD SDK — Agent GUI & Control Panel
══════════════════════════════════════════════════════════════
...
logger = logging.getLogger("conrrad.gui")
...
class AgentGUI:
    ...
    def _setup_routes(self):
        ...
        def index():
            ...
            <head>
                ...
                <title>{self.agent.name} - CONRRAD Control Panel</title>
                <style>
    ...
    def start(self):
        ...
        if not HAS_GUI:
            logger.error("FastAPI or Uvicorn not installed. Run: pip install conrrad-sdk[gui]")
            return

        # Print the auth token ONCE to the console (never to logs)
        print(f"")
        print(f"  🔐 CONRRAD CONTROL PANEL AUTH TOKEN")
        print(f"  ════════════════════════════════════")
