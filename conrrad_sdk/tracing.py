"""
CONRRAD SDK — Correlation ID & Distributed Tracing
══════════════════════════════════════════════════════
...
logger = logging.getLogger("conrrad.tracing")
...
_current_cid: contextvars.ContextVar[Optional[str]] = contextvars.ContextVar(
    "conrrad_correlation_id", default=None
)
...
class TraceContext:
    ...
    Inspired by CONRRAD core/correlation_id.py.
    """
