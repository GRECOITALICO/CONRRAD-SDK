"""
CONRRAD — Shadow Interceptor (Phase 1: Passive)
═══════════════════════════════════════════════════
Captures every LLM call passing through agent_base._call_api()
and writes a receipt to /var/log/conrrad/receipts.jsonl.

Activation: CONRRAD_SHADOW_INTERCEPT=1 environment variable.
...
logger = logging.getLogger("conrrad.shadow_interceptor")

# ─── Configuration ──────────────────────────────────────────
RECEIPTS_PATH = os.environ.get(
    "CONRRAD_RECEIPTS_PATH",
    "/var/log/conrrad/receipts.jsonl"
)
...
def is_active() -> bool:
    ...
    return os.environ.get("CONRRAD_SHADOW_INTERCEPT", "0") == "1"
