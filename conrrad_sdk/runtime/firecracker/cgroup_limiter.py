"""
CONRRAD SDK — cgroups v2 Resource Limiter for Firecracker VMMs
══════════════════════════════════════════════════════════════════
...
logger = logging.getLogger("conrrad.cgroups")
...
class VMResourceLimiter:
    ...
    def __init__(
        ...
        self.cgroup_path = os.path.join(CGROUP_ROOT, "conrrad", f"vm-{vm_id}")
