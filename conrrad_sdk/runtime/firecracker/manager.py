...
import time
import logging
from conrrad_sdk.security.ssrf import create_uds_client
from .integrity import verify_artifacts, IntegrityError
from .cgroup_limiter import VMResourceLimiter

logger = logging.getLogger("conrrad.firecracker.manager")
class FirecrackerManager:
    ...
    def start_vm(self, memory_mb=128, cpu_count=1, rootfs_read_only: bool = True):
        ...
        import tempfile
        import os
        runtime_dir = os.environ.get("XDG_RUNTIME_DIR", "/var/run/conrrad")
        try:
