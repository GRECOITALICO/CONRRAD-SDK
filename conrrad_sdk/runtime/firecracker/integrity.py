"""
CONRRAD SDK — Supply Chain Integrity Verifier
══════════════════════════════════════════════════
...
Usage:
    from conrrad_sdk.runtime.firecracker.integrity import verify_artifacts

    manifest = {
        "/opt/conrrad/vmlinux": "sha256:abc123...",
        "/opt/conrrad/rootfs.ext4": "sha256:def456...",
    }
...
logger = logging.getLogger("conrrad.integrity")
