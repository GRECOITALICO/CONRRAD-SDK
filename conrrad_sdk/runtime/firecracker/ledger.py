"""
Append-Only Cryptographic Audit Ledger for CONRRAD.
...
DEFAULT_AUDIT_LEDGER_PATH = os.getenv("CONRRAD_AUDIT_LEDGER", "/var/log/conrrad/audit.ledger")
...
class AuditLedger:
    ...
    def __init__(self, kms: Optional[BaseKMS] = None, ledger_path: Optional[str] = None):
        self.kms = kms
        self.ledger_path = ledger_path or DEFAULT_AUDIT_LEDGER_PATH
