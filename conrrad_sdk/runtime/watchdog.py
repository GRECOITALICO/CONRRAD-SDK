"""
CONRRAD — Watchdog (Nivel 3: External Process Monitor)
═════════════════════════════════════════════════════════════
...
logger = logging.getLogger("conrrad.runtime.watchdog")
...
class Watchdog:
    ...
    def start(self):
        ...
        self._thread = threading.Thread(target=self._run, daemon=True, name="conrrad-watchdog")
        self._thread.start()
