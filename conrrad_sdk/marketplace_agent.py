...
from conrrad_sdk.reputation.engine import ReputationEngine, AgentReputationMetrics
from conrrad_sdk.marketplace.listings import Marketplace, JobCategory
from conrrad_sdk.escrow.manager import EscrowManager
from conrrad_sdk.internal.paths import default_escrow_db
from conrrad_sdk.benchmarks.suite import BenchmarkSuite
from conrrad_sdk.dashboard_metrics import DashboardMetrics
...
class NativeMarketplaceAgent:
    """
    Agente nativo diseñado para la economía M2M de CONRRAD.
    ...
    def __init__(self, owner_id: str, name: str):
        ...
        self.escrow_manager = EscrowManager(db_path=str(default_escrow_db()))
