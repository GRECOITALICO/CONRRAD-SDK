        ...
        with open(log_path, 'r') as f:
            ...
            while True:
                ...
                if line:
                    ...
                    if "Iniciando Conrrad Shadow Mode Runner" in line:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log", type=str, default="/var/log/conrrad/shadow_mode_out.log", help="Path to the shadow mode log file")
