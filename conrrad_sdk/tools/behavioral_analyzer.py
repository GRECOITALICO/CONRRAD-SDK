"""
Conrrad Pay — Behavioral Intelligence Layer (Nivel 1.6)
═══════════════════════════════════════════════════════
...
def print_report(metrics: Dict):
    print(f"\n{C_CYAN}{C_BOLD}{'═' * 60}")
    print(f"  CONRRAD PAY — BEHAVIORAL INTELLIGENCE REPORT")
    print(f"{'═' * 60}{C_RESET}\n")
...
def main():
    parser = argparse.ArgumentParser(
        description="Conrrad Pay — Behavioral Intelligence Analyzer"
    )
