"""
Conrrad Pay — Case Explorer (Post-Mortem Offline Tool)
═══════════════════════════════════════════════════════
...
from conrrad_sdk.tools.behavioral_analyzer import (
...
def load_receipts(args) -> List[Dict]:
    ...
    if args.mock:
        from conrrad_sdk.tools.behavioral_analyzer import generate_mock_receipts
...
def main():
    parser = argparse.ArgumentParser(
        description="Conrrad Pay — Case Explorer (Post-Mortem)"
    )
