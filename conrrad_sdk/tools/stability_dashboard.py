...
Usage:
  python -m conrrad_sdk.tools.stability_dashboard --audit-log logs/audit.jsonl
  python -m conrrad_sdk.tools.stability_dashboard --simulate --conf 0.4 --dens 0.7
"""
import os
import json
import time
...
from conrrad_sdk.runtime.calibration_engine import CalibrationEngine
from conrrad_sdk.runtime.adaptive_budget import AdaptiveBudgetPolicy
from conrrad_sdk.runtime.policy_tuner import PolicyTuner
...
def render_dashboard(engine: CalibrationEngine, financial_metrics: Dict[str, float]):
    ...
    print(f"{C_BOLD}CONRRAD — Adaptive Execution Command Center{C_RESET}")
