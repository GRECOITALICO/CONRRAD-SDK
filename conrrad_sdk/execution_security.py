"""
CONRRAD SDK — Policy Engine + Execution Gate + Audit Logger
══════════════════════════════════════════════════════════════
...
Usage:
    from conrrad_sdk.security import (
...
logger = logging.getLogger("conrrad.security")
...
class AuditLogger:
    ...
    def __init__(
        self,
        log_path: str = "/var/lib/conrrad/audit.jsonl",
