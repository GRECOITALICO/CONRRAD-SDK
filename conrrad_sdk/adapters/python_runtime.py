...
from ..runtime.subprocess_runtime import SubprocessRuntime
from ..runtime.models import ExecutionRequest
from ..runtime.errors import ExecutionTimeout, SandboxViolation
import structlog

logger = structlog.get_logger("conrrad.adapters.python_runtime")
...
class PythonRuntimeAdapter(SecureAdapter):
    ...
    def __init__(self, security_layer: SecurityLayer = None):
        ...
        allow = os.environ.get("CONRRAD_ALLOW_UNSAFE_SUBPROCESS_RUNTIME") == "1"
