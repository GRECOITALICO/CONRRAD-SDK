"""
CONRRAD SDK — Browser Controller (Phase 6)
═══════════════════════════════════════════════
...
Usage:
    from conrrad_sdk.browser import BrowserController
...
logger = logging.getLogger("conrrad.browser")
...
class BrowserController:
    ...
    def __init__(
        ...
        user_agent: str = "Conrrad-SDK/3.0",
    ):
    ...
    def register_tools(self, tool_registry):
        ...
        """
        from conrrad_sdk.agent_runtime import Tool
