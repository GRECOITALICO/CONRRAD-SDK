"""
CONRRAD SDK — Agent Persistence & Recovery Engine (Phase 5.5)
════════════════════════════════════════════════════════════════
...
logger = logging.getLogger("conrrad.agent.persistence")
...
class CheckpointManager:
    ...
    def __init__(self, db_path: str = "/var/lib/conrrad/agent_checkpoints.db"):
