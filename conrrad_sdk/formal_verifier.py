"""
CONRRAD SDK — Formal Verifier (product)
═══════════════════════════════════════
...
Ported from CONRRAD core/sea/formal_verifier.py (Product subset).
...
Usage:
    from conrrad_sdk.formal_verifier import FormalVerifier, VerificationResult
...
logger = logging.getLogger("conrrad.formal_verifier")
    ...
    def __init__(
        ...
        Args:
            allowed_paths: Set of path prefixes where file operations are allowed.
                           Defaults to {"/tmp", "/workspace", "/var/lib/conrrad"}.
        ...
        """
        self._allowed_paths = allowed_paths or {"/tmp", "/workspace", "/var/lib/conrrad"}
