...
from .config import default_config, ConrradConfig
...
from .runtime.hybrid_runtime import HybridRuntime, HybridRuntimeConfig, ExecutionMode
from .runtime.models import ExecutionRequest

logger = structlog.get_logger("conrrad.agent")
...
class Agent:
    ...
    def __init__(
        ...
        name: str,
        description: str = "",
        system_prompt: str = "You are a highly capable CONRRAD autonomous agent.",
        rate_kern_per_task: float = 0.0,
        storage_dir: str = "~/.conrrad/agents",
        limits: Optional[ResourceLimits] = None,
        permissions: Optional[AgentPermissions] = None,
        capabilities: Optional[AgentCapabilities] = None,
        config: Optional[ConrradConfig] = None,
    ...
    def sell_idle_compute(self, minutes: int):
        ...
        import time
        from conrrad_sdk.security.ssrf import create_safe_client
        earned = minutes * 0.52
