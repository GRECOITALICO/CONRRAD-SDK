...
def _verify_actor_signature(actor_public_key_hex: str, message: str, signature_hex: str) -> bool:
    ...
    from conrrad_sdk.identity import verify_signature
...
class EscrowManager:
    ...
    def __init__(self, db_path: str = "/var/lib/conrrad/escrow.sqlite3", actor_keys: Optional[dict[str, str]] = None, ledger=None):
