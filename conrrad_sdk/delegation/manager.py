...
logger = logging.getLogger("conrrad.delegation.manager")
...
class SubAgentWorker:
    ...
    def execute(self, task: str) -> str:
        ...
        messages = [
            LLMMessage(role="system", content="You are a specialized CONRRAD worker sub-agent. Complete the task accurately and concisely. Return ONLY the requested data without conversational filler."),
