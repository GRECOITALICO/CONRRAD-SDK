...
logger = logging.getLogger("conrrad.resilience")
...
class CircuitBreaker:
    ...
    Inspired by CONRRAD core/circuit_breaker.py.
    """
...
class CircuitBreakerRegistry:
    ...
    Ported from CONRRAD monorepo core/circuit_breaker.py.
