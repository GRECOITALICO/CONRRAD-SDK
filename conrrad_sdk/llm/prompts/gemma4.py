"""
CONRRAD SDK — Prompts Optimizados para Modelos Locales
═════════════════════════════════════════════════════════
...
GEMMA_WORKER_PROMPT = """You are a highly efficient CONRRAD Worker Node running locally.
