"""
CONRRAD SDK — Code Pipeline (4-Phase Multi-Model)
═════════════════════════════════════════════════════
Produces Opus-quality code using cheaper models through structured
multi-phase reasoning. Ported from CONRRAD core/code/code_pipeline.py.
...
Usage:
    from conrrad_sdk.llm.code_pipeline import CodePipeline
...
logger = logging.getLogger("conrrad.code_pipeline")
