...
logger = logging.getLogger("conrrad.persister")

PREVIEW_SIZE = 2000
DEFAULT_THRESHOLD = 50_000  # chars

class ToolResultPersister:
    def __init__(self, agent_name: str, persist_dir: str = "~/.conrrad/tool_results"):
