...
from conrrad_sdk.runtime.firecracker.resilience import CircuitOpenError
from conrrad_sdk.runtime.firecracker import metrics as prom
...
class TestChaosFirecracker:
    ...
    def runtime(self):
        ...
        with patch("conrrad_sdk.runtime.firecracker_runtime.FirecrackerManager"), \
             patch("conrrad_sdk.runtime.firecracker_runtime.TenantManager"), \
             patch("conrrad_sdk.runtime.firecracker_runtime.BillingManager"), \
             patch("conrrad_sdk.runtime.firecracker_runtime.LocalKMS"):
    ...
    def test_byzantine_payload_rejection(self, runtime):
        ...
        """
        from conrrad_sdk.runtime.firecracker.auth_protocol import AuthenticationError
