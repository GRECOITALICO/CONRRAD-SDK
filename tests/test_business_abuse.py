...
import threading
from conrrad_sdk.escrow.manager import EscrowManager, EscrowState, EscrowError

def test_escrow_double_spend_race(monkeypatch, tmp_path):
    # Mock signature verification para centrarnos en la concurrencia
    monkeypatch.setattr("conrrad_sdk.escrow.manager._verify_actor_signature", lambda pub, msg, sig: True)
