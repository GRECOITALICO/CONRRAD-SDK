...
from conrrad_sdk.runtime import HybridRuntime, HybridRuntimeConfig, ExecutionMode
from conrrad_sdk.runtime.models import ExecutionRequest, ExecutionResult
from conrrad_sdk.runtime.errors import ExecutionTimeout

@pytest.fixture
def mock_runtimes():
    with patch('conrrad_sdk.runtime.hybrid_runtime.DockerRuntime') as MockDocker, \
         patch('conrrad_sdk.runtime.hybrid_runtime.FirecrackerRuntime') as MockFC, \
         patch('conrrad_sdk.runtime.hybrid_runtime.SubprocessRuntime') as MockSub:
