...
class TestDashboardAuthentication:
    ...
    def app_and_client(self):
        from conrrad_sdk.dashboard import CommandCenter
...
class TestCryptoIntegrity:
    ...
    @pytest.fixture
    def kdf_fast(self):
        from conrrad_sdk.crypto import KDFPreset
        return KDFPreset.FAST

    @pytest.fixture
    def sealed_envelope(self, kdf_fast):
        from conrrad_sdk.crypto import encrypt_private_key
    ...
    def test_seal_and_unseal_roundtrip(self, sealed_envelope):
        from conrrad_sdk.crypto import decrypt_private_key
    ...
    def test_tampered_ciphertext_rejected(self, sealed_envelope):
        from conrrad_sdk.crypto import decrypt_private_key, EncryptedKeyEnvelope
