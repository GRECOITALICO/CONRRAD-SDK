...
from conrrad_sdk.runtime.firecracker.auth_protocol import (
    AuthenticatedFrame,
    ReplayAttackError,
    AuthenticationError,
    ProtocolConfigError,
...
# Escrow Imports
from conrrad_sdk.escrow.manager import EscrowManager, EscrowState, Unauthorized, InvalidTransition, ReplayDetected, InvalidSignature
...
def test_invalid_state_transition(escrow):
    ...
    with patch("conrrad_sdk.escrow.manager._now", return_value=1000.0):
