...
from conrrad_sdk.policy_engine import PolicyEngine, AgentCapabilities, PolicyResult
from conrrad_sdk.security.a2a_replay import A2AReplayGuard, A2AReplayError
...
class TestRedisReplayGuard:
    ...
    def _make_guard(self):
        from conrrad_sdk.security.a2a_replay_redis import RedisReplayGuard
    ...
    def test_consume_nonce_calls_setnx(self):
        ...
        mock.set.assert_called_once_with(
            "conrrad:a2a:nonce:test-nonce", "1", nx=True, ex=600
        )
...
class TestMachineSecretHardening:
    ...
    def test_verify_permissions_warns_on_open_perms(self, tmp_path):
        from conrrad_sdk.identity import _verify_secret_file_permissions
    ...
    def test_machine_secret_tries_keyring_first(self):
        ...
        with patch.dict("sys.modules", {"keyring": mock_keyring}):
            from conrrad_sdk.identity import _get_machine_secret
