...
class TestCircuitBreaker:
    ...
    def setup_method(self):
        from conrrad_sdk.resilience import CircuitBreaker
    ...
    def test_starts_closed(self):
        from conrrad_sdk.resilience import CircuitState
    ...
    def test_execute_wrapper_records_failure(self):
        from conrrad_sdk.resilience import CircuitOpenError
...
class TestSLOMonitor:
    ...
    def setup_method(self):
        from conrrad_sdk.health import SLOMonitor
        self.slo = SLOMonitor(
            agent_name="test_agent",
    ...
    def test_healthy_when_no_errors(self):
        from conrrad_sdk.health import HealthStatus
        for _ in range(10):
...
class TestTracing:
    ...
    def test_trace_context_generates_correlation_id(self):
        from conrrad_sdk.tracing import TraceContext
    ...
    def test_trace_context_sets_global_id(self):
        from conrrad_sdk.tracing import TraceContext, get_current_trace_id
        with TraceContext(agent_name="test", operation="fetch") as trace:
...
class TestTokenEstimator:
    ...
    def test_estimate_returns_positive_for_nonempty_text(self):
        from conrrad_sdk.token_estimator import estimate_tokens
    ...
    def test_estimate_messages_counts_overhead(self):
        from conrrad_sdk.token_estimator import estimate_messages_tokens
        messages = [
...
class TestConstants:
    ...
    def test_valid_permissions_is_frozen(self):
        from conrrad_sdk.constants import VALID_PERMISSIONS
    ...
    def test_audit_log_records_and_trims(self):
        from conrrad_sdk.constants import AuditLog
...
class TestToolResultPersister:
    ...
    def test_small_output_passes_through(self, tmp_path):
        from conrrad_sdk.persister import ToolResultPersister
